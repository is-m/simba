...
public class CustomClassPathBeanDefinitionScanner extends ClassPathBeanDefinitionScanner {
  ...
  public void setAnnotationClass(Class<Mapper> class1) {
   ...
   /* GenericBeanDefinition definition;
    for (BeanDefinitionHolder holder : beanDefinitions) {
      ...
      if (logger.isDebugEnabled()) {
        logger
            .debug("Creating MapperFactoryBean with name '" + holder.getBeanName() + "' and '" + definition.getBeanClassName() + "' mapperInterface");
      }
